...
namespace SalesAndDistributionSystem.Services.Business.Security
{
    public class ReportConfigurationManager : IReportConfigurationManager
    {
        ...
        string AddOrUpdate_AddQuery() => @"INSERT INTO Report_Configuration 
                                      ...
                                      VALUES(:param1 ,:param2  ,:param3  ,:param4,:param5  ,:param6,:param7, :param8,:param9,:param10,TO_DATE(:param11, 'DD/MM/YYYY HH:MI:SS'),:param12, :param13)";
        string AddOrUpdate_UpdateQuery() => @"UPDATE Report_Configuration SET 
                                         ...
                                         Updated_By= :param9, Updated_Date= TO_DATE(:param10, 'DD/MM/YYYY HH:MI:SS'), Updated_Terminal= :param11 , REPORT_TITLE = :param12
        ...
        string AccRoleReportConfigUpdateQuery() => @"UPDATE ROlE_REPORT_CONFIGURATION SET PDF_PERMISSION = :param2,PREVIEW_PERMISSION =  :param3,
                                           CSV_PERMISSION = :param4, UPDATED_BY = :param5, UPDATED_DATE = TO_DATE(:param6, 'DD/MM/YYYY HH:MI:SS'),UPDATED_TERMINAL = :param7 WHERE ID = :param1";
        ...
        string UpdateUserReportConfigUpdateQuery() => @"UPDATE REPORT_USER_CONFIGURATION SET PDF_PERMISSION =:param1 ,PREVIEW_PERMISSION = :param2,CSV_PERMISSION =  :param3,
                                            UPDATED_BY = :param4, UPDATED_DATE = TO_DATE(:param5, 'DD/MM/YYYY HH:MI:SS'),UPDATED_TERMINAL = :param6 WHERE ID = :param7";
        ...
        //Report Permission --------------------------------------------------------------
        string LoadProductReportData_Query() =>
@"Select distinct  REPORT_ID, REPORT_NAME,ORDER_BY_SLNO, REPORT_TITLE,MENU_ID ,
 PDF_PERMISSION, PREVIEW_PERMISSION, CSV_PERMISSION from 
(Select distinct MC.REPORT_ID, MC.REPORT_NAME,MC.ORDER_BY_SLNO, MC.REPORT_TITLE, MC.MENU_ID ,
...
INNER JOIN REPORT_Configuration MC on MC.REPORT_ID = RU.REPORT_ID 
 ...
 INNER JOIN ROLE_USER_CONFIGURATION RUC on RRC.ROLE_ID = RUC.ROLE_ID where USER_ID = :param2 ) ) x";
