...
namespace SalesAndDistributionSystem.Services.Business.SalesAndDistribution
{
    ...
    {
        string GetReportTemplate(DataSet dataSet, string headerTitle, string companyName, string IsLogoAppllicable, string IsCompanyApplicable, Company_Info company_Info);
