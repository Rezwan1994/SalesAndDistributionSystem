...
namespace SalesAndDistributionSystem.Services.Business.SalesAndDistribution.Manager
{
  ...
  string LoadBonusMstById_Query() => @"Select
        ...
        string AddOrUpdate_AddBonus_MstQuery() => @"INSERT INTO BONUS_MST 
                                         ...
                                         VALUES ( :param1, :param2, :param3, TO_DATE(:param4, 'DD/MM/YYYY HH:MI:SS') ,TO_DATE(:param5, 'DD/MM/YYYY HH:MI:SS'),:param6 ,TO_DATE(:param7, 'DD/MM/YYYY HH:MI:SS'), :param8,TO_DATE(:param9, 'DD/MM/YYYY HH:MI:SS'),:param10 ,:param11,:param12,:param13)";
        string AddOrUpdate_UpdateBonusMst_Query() => @"UPDATE BONUS_MST SET 
                                          BONUS_NAME = :param2
                                         ,EFFECT_END_DATE = TO_DATE( :param3, 'DD/MM/YYYY HH:MI:SS')
                                         ,EFFECT_START_DATE = TO_DATE(:param4, 'DD/MM/YYYY HH:MI:SS')
                                         ,LOCATION_TYPE = :param5
                                         ,REMARKS = :param6
                                         ,STATUS = :param7
                                         ,UPDATED_BY = :param8, UPDATED_DATE = TO_DATE(:param9, 'DD/MM/YYYY HH:MI:SS'), 
        ...
        string AddOrUpdate_AddBonus_LocationQuery() => @"INSERT INTO BONUS_LOCATION 
                                         ...
                                         VALUES ( :param1, :param2, :param3, TO_DATE(:param4, 'DD/MM/YYYY HH:MI:SS') ,:param5,:param6 ,:param7, :param8,:param9)";
        ...
        string AddOrUpdate_AddBonus_DltQuery() => @"INSERT INTO BONUS_DTL 
                                         ...
                                         VALUES ( :param1, :param2, :param3, :param4, :param5,:param6 ,:param7, :param8,:param9,:param10,:param11 ,TO_DATE(:param12, 'DD/MM/YYYY HH:MI:SS'), :param13,:param14,:param15, :param16,:param17)";
        string AddOrUpdate_BonusDtl_Update_Query() => @"UPDATE BONUS_DTL SET 
                                          ...
                                          ,SLAB_QTY = :param12
                                          ,STATUS = :param13
                                         ,UPDATED_BY = :param14, UPDATED_DATE = TO_DATE(:param15, 'DD/MM/YYYY HH:MI:SS'), 
        ...
        string AddOrUpdate_Bonus_Declare_ProductQuery() => @"INSERT INTO BONUS_DECLARE_PRODUCT 
                                         ...
                                         VALUES ( :param1, :param2, :param3, :param4,:param5,:param6 ,TO_DATE(:param7, 'DD/MM/YYYY HH:MI:SS'), :param8,:param9,:param10,:param11 ,:param12)";
        ...
        public async Task<Bonus_Mst> LoadEditDataByMasterId(string db, int Id)
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                _bonus_Mst.EFFECT_START_DATE = dataTable.Rows[0]["EFFECT_START_DATE"].ToString();
                _bonus_Mst.EFFECT_END_DATE = dataTable.Rows[0]["EFFECT_END_DATE"].ToString();
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        listOfQuery.Add(_commonServices.AddQuery(AddOrUpdate_UpdateBonusMst_Query(), _commonServices.AddParameter(new string[] { model.BONUS_MST_ID.ToString(), model.BONUS_NAME, model.EFFECT_END_DATE, model.EFFECT_START_DATE, model.LOCATION_TYPE, model.REMARKS, model.STATUS })));
                        int location_id = _commonServices.GetMaximumNumber<int>(_configuration.GetConnectionString(db), GetNewBonus_location_IdQuery(), _commonServices.AddParameter(new string[] { }));
