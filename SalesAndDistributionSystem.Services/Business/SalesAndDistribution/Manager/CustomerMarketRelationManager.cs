...
namespace SalesAndDistributionSystem.Services.Business.SalesAndDistribution
{
    public class CustomerMarketRelationManager : ICustomerMarketRelationManager
    {
        ...
        string AddOrUpdate_Master_AddQuery() => @"INSERT INTO CUSTOMER_MARKET_MST 
                                         ...
                                         TO_DATE(:param7, 'DD/MM/YYYY HH:MI:SS'),TO_DATE(:param8, 'DD/MM/YYYY HH:MI:SS'), :param9,
                                         TO_DATE(:param10, 'DD/MM/YYYY HH:MI:SS'), :param11 )";
        string AddOrUpdate_Master_UpdateQuery() => @"UPDATE CUSTOMER_MARKET_MST SET 
                                           ...
                                           COMPANY_ID = :param6, EFFECT_START_DATE = TO_DATE(:param7, 'DD/MM/YYYY HH:MI:SS'),
                                           EFFECT_END_DATE = TO_DATE(:param8, 'DD/MM/YYYY HH:MI:SS'),
                                            UPDATED_BY = :param9, UPDATED_DATE = TO_DATE(:param10, 'DD/MM/YYYY HH:MI:SS'), 
        ...
        string LoadData_Detail_Query() => @"SELECT ROW_NUMBER() OVER(ORDER BY M.CUSTOMER_MARKET_DTL_ID ASC) AS ROW_NO,M.CUSTOMER_MARKET_DTL_ID,
                                          M.CUSTOMER_MARKET_MST_ID,   M.MARKET_ID,M.MARKET_CODE, M.COMPANY_ID, M.REMARKS,
        ...
        string LoadData_DetailByMasterId_Query() => @"SELECT ROW_NUMBER() OVER(ORDER BY M.CUSTOMER_MARKET_DTL_ID ASC) AS ROW_NO,M.CUSTOMER_MARKET_DTL_ID,
                                          M.CUSTOMER_MARKET_MST_ID, N.MARKET_NAME,  M.MARKET_ID,M.MARKET_CODE, M.COMPANY_ID, M.REMARKS,
                                          M.CUSTOMER_MARKET_DTL_STATUS,TO_CHAR(M.EFFECT_END_DATE, 'DD/MM/YYYY') EFFECT_END_DATE, TO_CHAR(M.EFFECT_START_DATE, 'DD/MM/YYYY') EFFECT_START_DATE  
        ...
        string AddOrUpdate_Detail_AddQuery() => @"INSERT INTO CUSTOMER_MARKET_DTL 
                                         ...
                                         TO_DATE(:param8, 'DD/MM/YYYY HH:MI:SS'),TO_DATE(:param9, 'DD/MM/YYYY HH:MI:SS'), :param10,
                                         TO_DATE(:param11, 'DD/MM/YYYY HH:MI:SS'), :param12 )";
        string AddOrUpdate_Detail_UpdateQuery() => @"UPDATE CUSTOMER_MARKET_DTL SET 
                                           ...
                                           EFFECT_END_DATE = TO_DATE(:param8, 'DD/MM/YYYY HH:MI:SS'),
                                            UPDATED_BY = :param9, UPDATED_DATE = TO_DATE(:param10, 'DD/MM/YYYY HH:MI:SS'), 
                                            UPDATED_TERMINAL = :param11 WHERE CUSTOMER_MARKET_DTL_ID = :param1";
        ...
        string DeleteCustomer_Market_Dtl_IdQuery() => "DELETE  FROM CUSTOMER_MARKET_DTL WHere CUSTOMER_MARKET_DTL_ID = :param1";
        ...
        string Existing_Market_Load_Query() => @"Select MARKET_ID,MARKET_CODE, MARKET_NAME from MARKET_INFO where  COMPANY_ID = :param1 AND MARKET_ID  not in (SELECT distinct MARKET_ID from CUSTOMER_MARKET_DTL where COMPANY_ID =:param1)";
                    ...
                    else
                    {
                        ...
                        foreach (var item in diivision_Market_Mst.customer_Market_Dtls)
                        {
                            ...
                            if(status)
                            {
                                ...
                                listOfQuery.Add(_commonServices.AddQuery(DeleteCustomer_Market_Dtl_IdQuery(), _commonServices.AddParameter(new string[] { item.CUSTOMER_MARKET_DTL_ID.ToString() })));
