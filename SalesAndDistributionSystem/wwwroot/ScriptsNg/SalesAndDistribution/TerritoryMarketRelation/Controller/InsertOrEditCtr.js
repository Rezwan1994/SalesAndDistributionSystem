    ...
    $scope.gridOptions.columnDefs = [
        ...
        , {
            name: 'EFFECT_END_DATE', field: 'EFFECT_END_DATE', displayName: 'End', enableFiltering: false, width: '15%', cellTemplate:
                ...
                + '<input  type="text" class="form-control" ng-disabled="row.entity.ROW_NO !=0" ng-change="grid.appScope.CheckENDDateValidation(row.entity)"  ng-model="row.entity.EFFECT_END_DATE" placeholder="dd/mm/yyyy"  id="EFFECT_END_DATE">'
                + '</div>'
                + '</div>'
        }
