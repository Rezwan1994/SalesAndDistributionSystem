    ...
    $scope.gridOptions.columnDefs = [
        ...
        , {
            name: 'EFFECT_START_DATE', field: 'EFFECT_START_DATE', displayName: 'Start', enableFiltering: false, width: '15%', cellTemplate:
                ...
                + '<input   ng-disabled="row.entity.ROW_NO !=0" type="text" class="form-control" ng-model="row.entity.EFFECT_START_DATE" placeholder="dd/mm/yyyy" id="EFFECT_START_DATE">'
                + '</div>'
                + '</div>'
        }
        , {
            name: 'EFFECT_END_DATE', field: 'EFFECT_END_DATE', displayName: 'End', enableFiltering: false, width: '15%', cellTemplate:
                ...
                + '<input   ng-disabled="row.entity.ROW_NO !=0" type="text" class="form-control" ng-model="row.entity.EFFECT_END_DATE" placeholder="dd/mm/yyyy" ng-change="grid.appScope.CheckENDDateValidation(row.entity)"  id="EFFECT_END_DATE">'
                + '</div>'
                + '</div>'
        }
