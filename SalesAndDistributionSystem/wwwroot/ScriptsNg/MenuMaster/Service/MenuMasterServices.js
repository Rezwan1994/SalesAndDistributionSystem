ngApp.service("MenuMasterServices", function ($http) {
    ...
    this.AddOrUpdate = function (model) {
        ...
        return $http({
            ...
            data: { COMPANY_ID: parseInt(model.COMPANY_ID), MENU_ID: model.MENU_ID, MENU_NAME: model.MENU_NAME, ORDER_BY_SLNO: parseInt(model.ORDER_BY_SLNO), PARENT_MENU_ID: parseInt(model.PARENT_MENU_ID), MODULE_ID: parseInt(model.MODULE_ID), CONTROLLER: model.CONTROLLER, ACTION: model.ACTION, AREA: model.AREA, HREF: model.AREA + "/" + model.CONTROLLER + "/" + model.ACTION },
    ...
    this.DeleteMenu = function (Id) {
        debugger
        return $http.post("../MenuMaster/DeleteMenu", { MENU_ID: Id });
    }
